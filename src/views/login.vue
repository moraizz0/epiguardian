<template>
  ...
  <div class="container-login">
    ...
    <div class="form-box">
      ...
      <!-- Formulario de login -->
      <!-- @submit.prevent="fazerLogin" = quando o usuario clica em "Entrar", chama a funçao fazerLogin() -->
      <form @submit.prevent="fazerLogin" class="formulario">
        ...
        <!-- Botao de envio -->
        <!-- :disabled="carregando" = desabilita o botao enquanto estao fazendo login -->
        <!-- Isso evita que o usuario clique multiplas vezes -->
        <button
          type="submit"
          class="botao-entrar"
          :disabled="carregando"
